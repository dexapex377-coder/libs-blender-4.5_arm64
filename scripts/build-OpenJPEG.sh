#!/bin/bash
# Build OpenJPEG for Android ARM64
set -euo pipefail
NDK_DIR="$1"; OUTPUT_DIR="$2"; BUILD_DIR="$3"; API_LEVEL="${4:-24}"
mkdir -p "$BUILD_DIR" && cd "$BUILD_DIR"
git clone --depth 1 --branch v2.5.3 https://github.com/uclouvain/openjpeg.git src
cd src
cmake -B build \
  ...
  -DBUILD_CODEC=OFF -DBUILD_TEST=OFF -DBUILD_DOC=OFF
